...
namespace FoodMartMongo.Controllers
{
    public class MailController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(MailPost mailPost)
        {
            if (string.IsNullOrWhiteSpace(mailPost.ReceiverMail))
            {
            ...
            var mailboxAddressTo = new MailboxAddress(mailPost.Name ?? "", mailPost.ReceiverMail);
            ...
            var bodyBuilder = new BodyBuilder
            {
				...
				<div style='font-family: Verdana, Geneva, Tahoma, sans-serif; line-height: 1.5; color: #333;'>
					<h1 style='color: #28a745;'>Tebrikler, {mailPost.Name}!</h1>
